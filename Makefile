...
test:
	mpirun --use-hwthread-cpus -np 1 ./life 1000 1000 1 new_grid.txt new_output.text
	mpirun --use-hwthread-cpus -np 4 ./life 1000 1000 1 new_grid.txt new_output_np.text
